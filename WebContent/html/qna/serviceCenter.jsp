...
<!--         <span onclick="this.parentElement.style.display='none'"="close">X</span>  -->
        ...
        <form action="/top/qna/update" method="post" id="modifyForm">
            ...
            <div class="mb-3">
                <input  class="form-control" name="topQnaTitle" id="topQnaTitle" value="" style="border:0 solid black" disabled >

            </div>
            <div><hr></div>
            <div class="mb-3">
                <textarea class="form-control" name="topQnaContents" id="topQnaContents" style="border:none"" rows="5" disabled style="resize: none;">
    ...
    <form action="/qna/write" method="post">
        ...
        <div class="qna"> 
            ...
            <div>
                ...
                <label class="qna_contents">
                    <p> <textarea rows="15" cols="64" placeholder="내용을 입력해주세요." style="resize: none;"></textarea></p>
                </label> <br>
                <p class="qna_btn">
