...
public class MyPageDAO {
	...
	public List<Recipe> myPageSelectAllRecipe(Connection conn, String userId) {
		...
		String query = "select user_id, recipe_title, F.file_name, recipe_contents,recipe_enrollDate, recipe_replycount, recipe_LikeCount from recipe R,recipe_file F where  R.file_no = F.file_no and r.file_no is not null and USER_ID=? and recipe_savestate='1' order by recipe_no";
