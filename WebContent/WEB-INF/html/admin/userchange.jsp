<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	String upageNavi = (String)request.getAttribute("upageNavi");
%>
...
<!--       <a href="#"><img src="/img/icon_header_search.png" alt=""></a> -->
    ...
    <c:forEach items="${requestScope.uList}" var="user" varStatus="index">
      <tr>
        ...
        <td><input type="checkbox" name="change" id="${user.userId}" value="${user.userId}"></td>
      </tr>
    </c:forEach>
    <hr>
	<tr>
...
<!--       </ul> -->
      ...
      <div class="removeCk">
        <input type="submit" value="관리자로 변경" id="removebtn">
      </div>
    </div>
  </div>
</div>
