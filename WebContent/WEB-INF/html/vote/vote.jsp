			...
			data : {
				...
				datasets : [ {
					...
					backgroundColor : [ 'rgba(255, 99, 132, 0.2)',
							...
							'rgba(75, 192, 13, 0.2)',
							'rgba(255, 159, 64, 0.2)' ],
					borderColor : [ 'rgb(255, 99, 132)', 'rgb(22, 11, 254)',
							'rgb(200, 205, 2)', 'rgb(75, 192, 192)',
							'rgb(54, 162, 235)', 'rgb(254, 1, 255)',
							'rgb(201, 20, 2)', 'rgb(201, 203, 207)',
							'rgb(75, 192, 13)', 'rgb(255, 159, 64)'
