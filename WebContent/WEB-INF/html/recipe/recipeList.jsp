...
<body>
    ...
    <span class="h1text" style="font-family:'Sunflower', sans-serif;font-size:3rem;font-weight:bold;">레시피</span>
    </div>
    <!-- 카테고리 -->
    <ul class="kategoire" padding: 20px 0 0 20px;">
        ...
        <li><a href="/legend/recipe"><span>명예의전당</span></a></li>
    ...
    <ul class="box">
        ...
        <c:if test="${rOne.recipeLegendState eq '1' }">
            <li class="legend-recipe">
	            ...
	            <div class="box-thumb" style="margin:0;">
	                <a href="/recipe/detail?recipeNo=${rOne.recipeNo }">
	                    <img style="width:250px; height:230px;object-fit:cover;" src="/upload/${rOne.fileName }" alt="" >
	                </a>
	            </div>
