...
<body>
	<div class="h1">
		<c:forEach items="${requestScope.mdList }" var="mdList"
			varStatus="index">
			<input type="text" id="msg-name" readonly value="${mdList.msgName }">
			<br>
			<span id="msg-sub">작성자 : ${mdList.msgSendUser }&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;작성일:
				${mdList.msgSendDate }</span>
			<form action="/delete/msg" method="get">
