...
<body>
	...
	<div style="width:1300px; margin: 0 auto;">
		...
		<ul class="amount" style="margin-left:19px;">
			...
			<div class="main_layout">
					...
					<div id="member" class="qnawrite_content" style="display: block;">
						<form action="/qna/write" method="post">
							...
							<input name="qnaTitle" class="inputTypeText" placeholder="제목입력"
								value="" type="text" style="background-color: white;width:1200px;height:70px;border-top:none;border-left:none;border-right:none;font-size:2rem;font-weight:bold;">
							...
							<div class="write-btn" style="text-align:center;">
								<input class="full-bu-b" type="submit" value="등록"> <input
									class="full-bu-b" type="reset" value="취소">
							</div>
						</form>
					</div>
				</div>
				<div id="qnalist" class="tabcontent"
					...
					<div style="text-align:center;"><h3>문의내역</h3></div>
