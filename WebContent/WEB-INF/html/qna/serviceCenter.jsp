	...
	<div style="width:1300px; margin: 0 auto;">
		<div class="main_layout" style="text-align: center;">
			<div style="text-align: center; margin-bottom:50px;margin-top:50px;">
    			<span style="font-family:'Sunflower', sans-serif;font-size:4rem;font-weight:bold;">자주하는 질문</span>
    		</div>
    			<div style="width:1500px;  margin-right:10px; display: inline-block;">
			<ul class="amount">
		...
		<div id="content" onclick="onDisplay" style="display: none;">
			...
			<form action="/top/qna/update" method="post" id="modifyForm">
				...
				<div class="mb-3">
					<input class="form-control" name="topQnaTitle" id="topQnaTitle" value="" disabled style="border:none; background: transparent;">
				</div>
				<hr>
				<div class="mb-3">
		...
		<ul class="amount">
			...
			<div class="main_layout" style="margin-top: 50px;">
				...
				<div id="qnawrite" class="tabcontent">
					...
					<h3 class="boxTitle"><span style="text-align:center; font-family:'Sunflower', sans-serif;font-size:3rem;font-weight:bold;">문의사항</span></h3>
					
					<div id="member" class="qnawrite_content" style="display: block;">
						<form action="/qna/write" method="post">
							<label class="id ePlaceholder"> 
							<input name="qnaTitle" class="inputTypeText" placeholder="제목입력"
								value="" type="text" style="margin-top:50px; width:1200px;height:30px;border-top:none;border-left:none;border-right:none;font-size:2rem;font-weight:bold;">
							</label><br> <label class="password ePlaceholder">
									<textarea name="qnaContent" 
										placeholder="내용을 입력해주세요." style="resize: none;width:1200px; height:400px;font-size:2rem;border-left:none;border-right:none;border-top:none;outline:none;"></textarea>
							</label>

							<div class="write-btn" style="text-align:center;">
								<input class="full-bu-b" type="submit" value="등록" style="width:100px"> 
								<input class="full-bu-b" type="reset" value="취소" style="width:100px">
							</div>
						</form>
					</div>
				</div>
				<div id="qnalist" class="tabcontent"
					...
					<div style="text-align:center;"><span style="font-family:'Sunflower', sans-serif;font-size:3rem;font-weight:bold;">문의내역</span></div>
					<table class="table table-hover" style="margin-top:50px; text-align:center;">
						<thead>
							<tr>
						...
						<c:forEach items="${requestScope.qList }" var="qOne"
							...
							<tbody>
								...
								<tr id="qnaDetail" style="display: none;">
									<td colspan="4">문의 내용 : ${qOne.qnaContent }
									</td>
								</tr>
								<c:if
									test="${qOne.replyContent ne null and qOne.replyContent ne '' }">
									<tr style="display: none;">
										<td colspan="4">문의 답변 : ${qOne.replyContent }
										</td>
									</tr>
								</c:if>
							</tbody>
